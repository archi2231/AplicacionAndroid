...
public class UsuarioDAO extends GenericDAO {
	...
	public void insertaRegistro(UsuarioDTO usuario) {
		...
		try {
			String query = String
					.format("INSERT INTO %s (nombreUsuario, CCnumber, numeroSS, contrasenia, nombrePila) VALUES (\"%s\",\"%s\",\"%s\",\"%s\",\"%s\")",
							getNombreTabla(), usuario.getNombreUsuario(),
							usuario.getCCnumber(), usuario.getNumeroSS(),
							usuario.getContrasenia(), usuario.getNombrePila());
